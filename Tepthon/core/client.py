                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @VR_1_R\
                                  \n\n--------بـدء تتبـع سجـل VR 𝗩𝞝𝗥 --------\
                        ...
                        link = "[𝗧𝗔𝗬𝗦𝗢𝗡(https://t.me/VR_1_R)"
                        text = (
                            "**✘ تقـريـر إشعـار VR 𝗩𝞝𝗥  ✘**\n\n"

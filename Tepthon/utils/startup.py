    ...
    try:
        ...
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                "https://telegra.ph/file/7f7713992b23e350a6bfb.jpg",
                
                caption="**•⎆┊تـم بـدء تشغـيل سـورس VR الخاص بك .. بنجاح 🧸♥️**",
                
                buttons=[(Button.url("𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥 ", "https://t.me/VR_11_V"),)],
...
async def mybot():
    ...
    if bot_name.endswith("Assistant"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", "VR")
            ...
            await bot.send_message("@BotFather", f"- بـوت VR المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
...
Tepthon = {"@Tepthon", "@VR_SOURCE", "@VR_SOURCE_1", "@VR_1_R", "@L_O_SHA_2"}
async def saves():
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            ...
            "كـروب السجـل VR", zedub, Config.TG_BOT_USERNAME, descript, photozed

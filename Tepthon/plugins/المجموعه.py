...
CHANNELS_STR = "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - احصـائيـات جميـع القنـوات** 𓆪\n\n"
CHANNELS_ADMINSTR = "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - احصـائيـات جميـع القنـوات اشـراف** 𓆪\n\n"
CHANNELS_OWNERSTR = "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - احصـائيـات جميـع القنـوات ملكيـة** 𓆪\n\n"
GROUPS_STR = "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - احصـائيـات جميـع المجمـوعـات** 𓆪\n\n"
GROUPS_ADMINSTR = "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - احصـائيـات جميـع المجمـوعـات اشـراف** 𓆪\n\n"
GROUPS_OWNERSTR = "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - احصـائيـات جميـع المجمـوعـات ملكيـة** 𓆪\n\n"
# =========================================================== #
#                                                           ZThon                                                                #
# =========================================================== #
...
async def stats(event):  # sourcery no-metrics
    ...
    response = f"𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - احصـائيـات {full_name}** 𓆪\n"
...
async def _(event):  # sourcery no-metrics
    ...
    async for i in event.client.iter_participants(event.chat_id):
        ...
        if i.bot:
            ...
            n += 1
    if input_str:
        required_string = """𓆰 𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻 
...
𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"""
        ...
        await sleep(5)
    await et.edit(
        """𓆰 𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - معـلومـات المجمـوعــه** 𓆪\n 𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻
⪼ **العدد ↫ {} **مستخدماً
⪼ **الحسابات المحذوفه ↫** {}
⪼ **اخر ظهور منذ زمن طويل ↫** {}
⪼ **اخر ظهور منذ شهر ↫** {}
...
async def count(event):
    ...
    result += f"𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  **- 🝢 - احصـائيـات الحسـاب** 𓆪\n"

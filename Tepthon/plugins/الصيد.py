...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  - أوامـر الصيد والتشيكـر](t.me/VR_11_V ) 𓆪\n\n"
    ...
    "**⪼ لـ رؤيـة بعـض اليـوزرات التي قام بصيدهـا منصبيـن تيبثـــون**\n\n"
...
"𓆩 [𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  - أنـواع اليـوزرات](t.me/VR_11_V ) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    about="This channel to hunt username by - @VR_11_V  ",
    ...
    try:
        ...
        ch = await zedub(
            ...
            functions.channels.CreateChannelRequest(
                ...
                about="تم تثبيت اليـوزر بواسطـة سـورس تيبثـــون - @VR_11_V  ",

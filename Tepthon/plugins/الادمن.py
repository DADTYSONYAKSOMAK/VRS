...
zel_dev = (5847230349, 5847230349, 5847230349, 5847230349)
...
async def _ban_person(event):
    ...
    if user.id == 5847230349 or user.id == 5847230349 or user.id == 5847230349:
...
async def startmute(event):
    KTM_IMG = gvarstatus("KTM_PIC") or "https://telegra.ph/file/4e20b1401a3e3c7e98bb3.jpg"
    if event.is_private:
        ...
        if event.chat_id == 5847230349 or event.chat_id == 5847230349 or event.chat_id == 5847230349:

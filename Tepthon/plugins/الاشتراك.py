...
async def supc(event):  # Zed-Thon - ZelZal
    ...
    zed_dev = (5847230349, 5847230349, 5847230349, 5847230349)
    ...
    if gvarstatus ("sub_private"):
        try:
            ...
            if "error_code" in reqt:
                await zedub.tgbot.send_message(BOTLOG_CHATID, f"**- خطـأ غير معروف قم باعادة توجيه الرسالة ل@VR_1_R لحل المشكلة\n{reqt}**")

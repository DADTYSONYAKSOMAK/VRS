...
ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت VR"
ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ "
ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝗩𝞝𝗥 ─┄─┄─┄─⋆"
zed_dev = (5847230349, 5847230349)
zel_dev = (5847230349, 5847230349)
zelzal = (5847230349, 5847230349)

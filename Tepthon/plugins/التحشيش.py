...
async def _(zed):
    await edit_or_reply (zed, "𓆰 [𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/TepThon) 🗑♻️𓆪\n**𓍹━─━─━─━─𝗧𝞝𝗣─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
async def permalink(mention):
    ...
    if user.id == 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀or user.id == 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀or user.id == 5847230349:
...
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀- اوامـر التحشيش](t.me/VR_11_V) 𓆪\n\n"

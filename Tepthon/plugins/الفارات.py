...
ZelzalVP_cmd = (
    "𓆩 [𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/VR_11_V) 𓆪\n\n"
    ...
    "\n𓆩 [ 𝙑𝙖𝙧𝙨 - قنـاة الفـارات](t.me/VR_11_V) 𓆪"
)
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if variable in heroku_var:
            await zed.edit("**❈╎تم تغييـر {} بنجـاح ☑️**\n**❈╎المتغيـر : ↶**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت تيبثـون يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, vinfo))
        else:
            await zed.edit("**❈╎تم إضـافـة {} بنجـاح ☑️** \n**❈╎المضاف اليه :**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت تيبثـون يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, vinfo))
        ...
        if BOTLOG_CHATID:
                ...
                f"#فتـرة_الايقـاف_المـؤقت_للترحيب\
                        \n**- تم اضافة الفتـرة من الساعة {vinfo} الى الساعة 6 صباحـًا .. بنجـاح ✓**",
            )
    else:
        if input_str:
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await zed.edit("**❈╎تم حـذف {} بنجـاح ☑️**\n**❈╎المتغيـر المحـذوف : ↶**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت تيبثـون يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, variable))
...
async def custom_zed(event):
    ...
    if (input_str == "كليشة الحماية" or input_str == "كليشة الحمايه" or input_str == "كليشه الحماية" or input_str == "كليشه الحمايه"):
        ...
        if variable is None:
            ...
            await zed.edit("**❈╎الفـار {} موجـود ☑️**\n**❈╎قيمـة الفـار : ↶**\n `{}` \n\n**❈╎قنـاة السـورس : @VR_11_V **".format(input_str, variable))
...
async def variable(event):
    ...
    if input_str == "العراق" or input_str == "اليمن" or input_str == "سوريا" or input_str == "السعودية" or input_str == "لبنان" or input_str == "الاردن":
        ...
        await asyncio.sleep(1.5)
        if variable in heroku_var:
            await zed.edit("**❈╎تم تغييـر المنطقـة الزمنيـة .. بنجـاح ☑️**\n**❈╎المتغير : ↶**\n دولـة `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت تيبثـون يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str))
        else:
    ...
    if malatha.reply_to_msg_id:
        ...
        if input_str in ["الحماية", "الحمايه"]:
            ...
            try:
                ...
                await zed.edit("**❈╎تم تغييـر صـورة {} .. بنجـاح ☑️**\n**❈╎المتغيـر : ↶**\n `{}` \n\n**❈╎قنـاة السـورس : @VR_11_V**".format(input_str, vinfo))

...
ZelzalDV_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗩𝞝𝗥 - اوامــر المطـور المســاعد](t.me/VR_11_V) 𓆪\n\n"
    ...
    "**- لـ عـرض قائمـة بالاوامـر المسمـوحـة والغيـر مسمـوحـة للمطـوريـن التحكـم فيهـا 🛃🚷** \n\n"
    "\n𓆩 [ 𝗠𝗢𝗛𝗔𝗠𝗔𝗗 - مطـور السـورس](t.me/VR_1_R) 𓆪"
)
...
async def add_sudo_user(event):
    ...
    output += "**✾╎يتم الان اعـادة تشغيـل بـوت 𝗩𝞝𝗥 𝗩𝞝𝗥 انتظـر 2-1 دقيقـه ▬▭ ...**"
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝗩𝞝𝗥 :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    if input_str[0] == "آمن":
        ...
        for plugin in input_str:
            if plugin not in PLG_INFO:
                errors += (
                    f"`{plugin}` __There is no such plugin in your Tepthon__.\n"
                )
            else:
    ...
    output = (
        result + "**✾╎يتم الان اعـادة تشغيـل بـوت 𝗩𝞝𝗥 𝗩𝞝𝗥 انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
...
async def _(event):  # sourcery no-metrics
    ...
    error = ""
    if not input_str:
        text = "**•🧑🏻‍💻• قائمــة الاوامـر المسمـوحـة لـ المطـوريـن المـرفـوعيـن فـي البـوت الخـاص بـك 🏧:**"
        ...
        text = "**•🧑🏻‍💻• قائمــة الاوامـر الغيـر مسمـوحـة 📵 لـ المطـوريـن المـرفـوعيـن فـي البـوت الخـاص بـك :**"

...
ZelzalCoins_cmd = (
    "[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝞝𝗥  - اوامـر تجميـع النقـاط](t.me/VR_11_V) 𓆪\n\n"
    "**𓆰 قـائمـة اوامـر تجميـع نقـاط بوتـات تمـويـل الخاص بسـورس 𝗩𝞝𝗥🦾 :** \n\n"
    "`.المليار`\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- مـلاحظــه :**\n"
    "**⪼ سيتم اضـافـه المزيـد من البوتـات بالتحديثـات الجايـه .. إذا تريـد اضافـة بـوت محـدد راسـل مطـور السـورس @VR_1_R **"
)
